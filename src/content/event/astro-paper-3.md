...
Before reading the rest of the section, you might also want to check [this article](https://astro-paper.pages.dev/events/how-to-update-dependencies/) for upgrading dependencies and AstroPaper.
...
Therefore, all the `BlogFrontmatter` type inside files need to be updated with `CollectionEntry<"event">["data"]`.
...
Actually, I've already written a blog post for this case and you can check out [here](https://astro-paper.pages.dev/events/how-to-update-dependencies/#updating-astropaper-using-git).
