...
If you don't know how you can configure color schemes, check [this blog post](https://astro-paper.pages.dev/events/customizing-astropaper-theme-color-schemes/).
